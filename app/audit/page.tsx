  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:title" content="Audit telefonu zdarma | mobilnamiru.cz" />
        <meta property="og:description" content="Komplexní audit + personalizovaný AI report zdarma." />
            ...
            {!isStarted ? (
              <div className="text-center max-w-xl mx-auto">
                ...
                <p className="text-muted-foreground text-lg mb-8">
                  30 otázek, které odhalí, kde má tvůj telefon rezervy. AI ti vytvoří 
                  personalizovaný report s konkrétními kroky – co nastavit, proč a jak.
                </p>
                <Button size="lg" onClick={handleStart} className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground shadow-lg shadow-primary/20 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-secondary/30">
                  Začít audit
                  <ArrowRightIcon />
                </Button>
              ...
              <div className="text-center max-w-xl mx-auto py-12">
                ...
                <h2 className="text-2xl font-bold mb-2">Generuji tvůj report...</h2>
                <p className="text-muted-foreground">AI analyzuje tvé odpovědi a připravuje personalizovaná doporučení.</p>
              </div>
            ) : (
