...
import { Download, Share2, Loader2, FileText, Crown, Video, Sparkles } from "lucide-react";
...
const quickWins = [
  {
    ...
    description: "Nastavení → [tvé jméno] → iCloud → Záloha na iCloudu. Mělo by svítit Zapnuto a poslední záloha by neměla být starší než 24 hodin.",
  },
  {
    title: "Zapni Find My",
    description: "Nastavení → [tvé jméno] → Najít → Najít iPhone. Zapni všechny tři přepínače – chrání tě to při ztrátě nebo krádeži.",
  },
];
...
export default function ThankYou() {
  ...
  const handleFullReportClick = () => {
    ...
    toast({
      ...
      description: "Platební brána bude brzy k dispozici. Zatím nás kontaktuj přímo.",
    });
  };
  ...
  const handleConsultationClick = () => {
    ...
    toast({
      ...
      description: "Rezervační systém bude brzy k dispozici. Zatím nás kontaktuj přímo.",
    });
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Report je na cestě. Mezitím si projdi dva quick wins." />
      ...
      <main className="min-h-screen pt-24 pb-16">
        <div className="container-narrow">
            ...
            <div className="glass rounded-2xl p-6 md:p-8">
              {isLoading ? (
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-muted-foreground">Načítám tvůj report...</p>
                </div>
              ) : report ? (
                <div 
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="glass rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-primary/50 transition-colors">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground">Kompletní Report</h3>
                    <p className="text-sm text-muted-foreground">10-15 tipů + návody</p>
                  </div>
                </div>
                <ul className="space-y-2 mb-6 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">Kompletní 60min návod krok za krokem</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">10-15 personalizovaných tipů</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">Doručení do 24 hodin</span>
                  </li>
                </ul>
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-bold text-foreground">299 Kč</span>
                    <span className="text-sm text-muted-foreground ml-2">jednorázově</span>
                  </div>
                  <Button 
              ...
              <div className="glass rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-secondary/50 transition-colors">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground">Online Konzultace</h3>
                    <p className="text-sm text-muted-foreground">Nastavíme spolu</p>
                  </div>
                </div>
                <ul className="space-y-2 mb-6 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">60-90 min online session</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">Nastavíme telefon společně</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">Kompletní report v ceně</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckIcon className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">30 dní podpora po konzultaci</span>
                  </li>
                </ul>
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-bold text-foreground">od 990 Kč</span>
                  </div>
                  <Button 
                    variant="outline"
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-6 text-center">
              2 quick wins, které můžeš udělat <span className="gradient-text">hned teď</span>
            </h2>
            <div className="grid md:grid-cols-2 gap-6">
