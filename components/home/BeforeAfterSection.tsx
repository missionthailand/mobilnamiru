...
const scenarios = [
  {
    ...
    expandedContent: {
      ...
      description:
        "Majitel e-shopu, který denně řešil desítky zpráv od klientů, dodavatelů a týmu. Po optimalizaci telefonu získal zpět kontrolu nad svým časem.",
      details: [
  ...
  },
  {
    ...
    expandedContent: {
      ...
      description:
        "Rodina se dvěma dětmi (8 a 12 let), kde Screen Time způsoboval denní konflikty. Po nastavení jasných pravidel a limitů se situace výrazně zlepšila.",
      details: [
  ...
  },
  {
    ...
    expandedContent: {
      ...
      description:
        "Marketingový specialista, který kontroloval telefon 150× denně. Po optimalizaci notifikací a nastavení Focus režimů získal zpět soustředění.",
      details: [
...
const BeforeAfterSection = () => {
  ...
  const getPieChartData = (stats: (typeof scenarios)[0]["stats"]) => [
    {
      name: "Produktivní čas",
      value: 100 - stats.screenTimeReduction + stats.efficiencyIncrease,
    },
              ...
              <div className="p-6">
                ...
                <div className="mt-4 pt-4 border-t border-border/50 text-center">
                  <span className="text-xs text-muted-foreground">
                    Klikni pro detailní statistiky →
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6 mt-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="glass rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-secondary">
                      {selectedScenario.stats.timeSaved}
                    </div>
                  ...
                  <div className="glass rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-success">
                      +{selectedScenario.stats.efficiencyIncrease}%
                    </div>
                    <div className="text-xs text-muted-foreground">
                      efektivita
                    </div>
                  ...
                  <div className="glass rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-primary">
                      -{selectedScenario.stats.screenTimeReduction}%
                    </div>
                    <div className="text-xs text-muted-foreground">
                      čas u obrazovky
                    </div>
                  ...
                  <div className="glass rounded-xl p-4 text-center">
                    <div className="text-2xl font-bold text-secondary">
                      -{selectedScenario.stats.stressReduction}%
                    </div>
                ...
                <div className="glass rounded-xl p-4">
                  ...
                  <ResponsiveContainer width="100%" height={200}>
                    <BarChart
                      data={getBarChartData(selectedScenario.stats)}
                      layout="vertical"
                    >
                      <CartesianGrid
                        strokeDasharray="3 3"
