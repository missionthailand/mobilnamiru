    ...
    <section className="relative min-h-screen flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="container-wide relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* H1 */}
          <h1
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight animate-fade-in"
            style={{
              animationDelay: "0.1s",
            }}
          >
            Tvůj telefon může být{" "}
            <span className="gradient-text">tvůj kokot</span>, ne zdroj stresu
          </h1>
          ...
          >
            Nastavíme ti notifikace, režimy, bezpečnost a workflow přesně na
            míru. Získáš zpět klid, čas a jistotu, že máš vše pod kontrolou.
          </p>
        ...
        <div
          ref={phoneRef}
          className={`mt-16 md:mt-24 relative transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16"}`}
        >
          <div className="max-w-lg mx-auto">
            <div className="relative">
              ...
              <div
                className="absolute -left-4 sm:-left-16 top-1/4 glass px-4 py-2 rounded-xl transition-all duration-500"
                style={{
              ...
              >
                <span
                  className={`${benefits[visibleBenefits[0]].color} text-sm font-medium drop-shadow-sm`}
                >
                  ✓ {benefits[visibleBenefits[0]].text}
                </span>
              </div>
              <div
                className="absolute -right-4 sm:-right-16 top-1/2 glass px-4 py-2 rounded-xl transition-all duration-500"
                style={{
              ...
              >
                <span
                  className={`${benefits[visibleBenefits[1]].color} text-sm font-medium drop-shadow-sm`}
                >
                  ✓ {benefits[visibleBenefits[1]].text}
                </span>
              </div>
              <div
                className="absolute -left-4 sm:-left-12 bottom-1/4 glass px-4 py-2 rounded-xl transition-all duration-500"
                style={{
              ...
              >
                <span
                  className={`${benefits[visibleBenefits[2]].color} text-sm font-medium drop-shadow-sm`}
                >
