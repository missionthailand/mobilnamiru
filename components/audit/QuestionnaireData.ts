  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        question:
          'U kterých situací se ti nejčastěji stane „jen mrknu a ztratím 20 minut"?',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        question:
          'Souhlasíš s tím, že ti navrhnu i „režimové" změny (nejen technické)?',
...
export const branchingSections: BranchingSection[] = [
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "manufacturer",
            label: "Záloha výrobce (Samsung, Xiaomi...)",
          },
  ...
  // Work communication intensive
  {
    ...
    condition: (answers) =>
      ...
      (answers.daily_messages === "50-150" ||
        answers.daily_messages === "150+"),
    questions: [
      {
...
export const getApplicableBranches = (
...
export const getTotalQuestionCount = (answers: Record<string, any>): number => {
  const mainCount = questionnaireSections.reduce(
    (acc, section) => acc + section.questions.length,
    0,
  );
  const branchCount = getApplicableBranches(answers).reduce(
    (acc, section) => acc + section.questions.length,
    0,
  );
